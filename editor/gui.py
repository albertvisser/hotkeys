...
if toolkit == 'qt':
    ...
    from .dialogs_qt import show_message, show_cancel_message, ask_question, ask_ync_question, \
        get_textinput, get_choice, get_file_to_open, get_file_to_save, show_dialog, \
        InitialToolDialog, FilesDialog, ColumnSettingsDialog, ExtraSettingsDialog, EntryDialog, \
        NewColumnsDialog
elif toolkit == 'wx':

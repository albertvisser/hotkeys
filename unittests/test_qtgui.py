...
class TestSingleDataInterface:
    ...
    def _test_on_item_selected(self, monkeypatch, capsys):
        ...
        """
        testobj = self.setup_testobj(monkeypatch, capsys)
        assert testobj.on_item_selected(newitem, olditem) == "expected_result"
        assert capsys.readouterr().out == ("")
    ...
    def _test_on_update(self, monkeypatch, capsys):
        ...
        """
        testobj = self.setup_testobj(monkeypatch, capsys)
        assert testobj.on_update() == "expected_result"
        assert capsys.readouterr().out == ("")
    ...
    def _test_on_delete(self, monkeypatch, capsys):
        ...
        """
        testobj = self.setup_testobj(monkeypatch, capsys)
        assert testobj.on_delete() == "expected_result"
        assert capsys.readouterr().out == ("")
    ...
    def _test_set_listitemtext(self, monkeypatch, capsys):
        ...
        """
        testobj = self.setup_testobj(monkeypatch, capsys)
        assert testobj.set_listitemtext(item, indx, value) == "expected_result"
        assert capsys.readouterr().out == ("")
    ...
    def _test_add_listitem(self, monkeypatch, capsys):
        ...
        """
        testobj = self.setup_testobj(monkeypatch, capsys)
        assert testobj.add_listitem(new_item) == "expected_result"
        assert capsys.readouterr().out == ("")
    ...
    def _test_get_widget_text(self, monkeypatch, capsys):
        ...
        """
        testobj = self.setup_testobj(monkeypatch, capsys)
        assert testobj.get_widget_text(ted, text) == "expected_result"
        assert capsys.readouterr().out == ("")
    ...
    def _test_get_choice_value(self, monkeypatch, capsys):
        ...
        """
        testobj = self.setup_testobj(monkeypatch, capsys)
        assert testobj.get_choice_value(cb, dummy, text) == "expected_result"
        assert capsys.readouterr().out == ("")
    ...
    def _test_get_check_value(self, monkeypatch, capsys):
        ...
        """
        testobj = self.setup_testobj(monkeypatch, capsys)
        assert testobj.get_check_value(cb, state) == "expected_result"
        assert capsys.readouterr().out == ("")
    ...
    def _test_get_keydef_at_position(self, monkeypatch, capsys):
        """unittest for SingleDataInterface.get_keydef_at_position
        """
        testobj = self.setup_testobj(monkeypatch, capsys)
        assert testobj.get_keydef_at_position(pos) == "expected_result"
        assert capsys.readouterr().out == ("")
...
class TestGui:
    ...
    def _test_create_menuaction(self, monkeypatch, capsys):
        """unittest for Gui.create_menuaction
        """
        testobj = self.setup_testobj(monkeypatch, capsys)
        assert testobj.create_menuaction(sel, callback, shortcut) == "expected_result"
        assert capsys.readouterr().out == ("")

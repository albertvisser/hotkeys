...
from tcmdrkeys import scikeys
## import datetime
INI = "scikey_config.py"
from .hotkeys_shared import * # constants

class SciTEPanel(HotkeyPanel):
    ...
    def __init__(self, parent):
        ...
        self.ini = scikeys.SciKSettings(INI) # 1 pad + language instelling
        self.readkeys()
        self.modified = False
    ...
    def readkeys(self):
        self.data = scikeys.readkeys(self.ini.pad)

    def savekeys(self):
        scikeys.savekeys(self.ini.pad, self.data)
        self.modified = False
    ...
    def populate_list(self):
        ...
        for key, data in items:
            ...
            soort = C_DFLT if data[1] == "S" else C_RDEF
            new_item.setText(1, self.captions[soort])
...
class MainWindow(gui.QMainWindow):
    ...
    def __init__(self): # , args):
        ...
        self.setWindowTitle("SciTE keys")
        self.resize(wid, hig)
        self.sb = self.statusBar()
        self.sb.showMessage('Welcome to SciTE Keys!')
    ...
    def readcaptions(self, lang):
        ...
        self.captions['000'] = 'SciTE hotkeys'
